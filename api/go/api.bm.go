...
var PathDemoPing = "/user.service.v1.Demo/Ping"
var PathDemoSayHello = "/user.service.v1.Demo/SayHello"
...
func RegisterDemoBMServer(e *bm.Engine, server DemoBMServer) {
	DemoSvc = server
	e.GET("/user.service.v1.Demo/Ping", demoPing)
	e.GET("/user.service.v1.Demo/SayHello", demoSayHello)
	e.POST("/kratos-demo/say_hello", demoSayHelloURL)
}
